...
module_model_diagnostic_predefined_UI <- function(id, label = "") {
...
################################################################################ 
################################################################################
# module_model_diagnostic_predefined
################################################################################
################################################################################
...
module_model_diagnostic_predefined <- function(input, output, session, 
  ...
  output$dataset_container <- renderUI({ 
    ...
    callModule(module_save_data, "loaded_dataset", ALL, data=xpdb %>% slot("Data"), data_name="")
  ...
  observeEvent({xpdb_inputData99999()}, {
