...
; 3) add time-dependent CL component
...
$PK 
 ...
 ;CL IS TIME-DEPENDENT 
TVEMAX = THETA(13)
TVT50 = THETA(14)
HILL = THETA(15)
 EMAX = TVEMAX*EXP(ETA(8))             ; INDIVIDUAL EMAX 
 T50 = TVT50*EXP(ETA(9))               ; INDIVIDUAL T50
 CL = CL*EXP(EMAX*TIME**HILL/(T50**HILL+TIME**HILL))     ; Sigmoid Emax model
