...
```{r, eval=TRUE, fig.align='center', fig.cap="my first figure in Rmd using handbook"}

#fig = ALL$FIGURE[[1]]
fig = ggplot(dataset, aes(x=TIME, y=DVOR, group=USUBJID, color=ARMA)) + 
