...
- rmd/03_summary_dataset/01_summary_dataset.Rmd
- rmd/04_descriptive_analysis/01_stdtimeprofile.Rmd
- rmd/04_descriptive_analysis/02_pkpd_relationship.Rmd
- rmd/04_descriptive_analysis/03_NCA_analysis.Rmd
- rmd/06_nmdat_integrity_check/01_load_data.Rmd
- rmd/06_nmdat_integrity_check/02_quick_check.Rmd
- rmd/06_nmdat_integrity_check/03_advanced_check.Rmd
- rmd/06_nmdat_integrity_check/04_buildIn_model.Rmd
- rmd/07_run_nmmodel/01_run_nonmem_model.Rmd
- rmd/07_run_nmmodel/02_model_diagnostic.Rmd
- rmd/07_run_nmmodel/03_model_decision_tree.Rmd
- rmd/08_run_simulation/01_run_sim.Rmd
- rmd/09_exposure_response/01_exposure_response.Rmd
- rmd/10_advanced_model/01_advanced_model.Rmd
- rmd/11_reporting/01_reporting.Rmd
...
```{r child = './rmd/04_descriptive_analysis/01_stdtimeprofile.Rmd'}
```

```{r child = './rmd/04_descriptive_analysis/02_pkpd_relationship.Rmd'}
```

```{r child = './rmd/04_descriptive_analysis/03_NCA_analysis.Rmd'}
```
...
```{r child = 'rmd/08_run_simulation/01_run_sim.Rmd'}
```

```{r child = 'rmd/09_exposure_response/01_exposure_response.Rmd'}
```
