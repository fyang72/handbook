...
- Based on LN900A but added MM component which is from J Elassaiss‐Schaap, 2017
...
TVV3  :  1.65  :   
TVKA  :  0.4  :   
TVVMAX  :  0.114  :    from J Elassaiss‐Schaap 2017

TVKSS  :  0.0784  :     from J Elassaiss‐Schaap 2017
TVF1   :  0.7  :  
RUVCV  :  0.188  :  
RUVSD  :  1.48  :  
TVEMAX :  -0.410  :  
...
$TABLE
  ...
  double SD=sqrt(ADD*ADD+PROP*PROP*CONC*CONC) ;    //untransformed scale
