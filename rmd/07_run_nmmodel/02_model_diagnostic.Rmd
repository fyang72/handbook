...
output$user_specified_diagnostic_plot <- renderUI({ 
  ...
  # module_run_script
  ALL = callModule(module_run_script, "user_specified_diagnostic_plot", 
                   ALL, 
                   dataset=xpdb_inputData(),
                   script=script)

  module_run_script_UI(("user_specified_diagnostic_plot"), label = NULL) 
