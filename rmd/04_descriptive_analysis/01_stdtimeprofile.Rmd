...
Step-by-step instruction is follows: 

1. You need to load your dataset first (see below), by three methods mentioned earlier.
Following the loading, the dataset will be presented in the tab of *dataset*,
you may apply those commonly used filters to narrow down your dataset. 
