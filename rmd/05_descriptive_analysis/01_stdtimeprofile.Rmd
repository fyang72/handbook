...
in both log- and linear-scale (see section [Time profile](#time_profile)).  A variety of visualization for PK-PD analyses are presented in section [PKPD relationship](#descriptive_PKPD)) 
...
Note you can only choose one analye; you may choose multiple analytes at next section of PKPD relationship.
