...
You need to load your dataset first (see below), by three methods mentioned earlier.
If loading sucessfully, the dataset will be presented in the tab of *dataset*. 
Within the tab, some commonly used filters will be shown and they could be used to narrow down your dataset.
Note the loaded data will be used in all sections in this chapter. 
